    ...
    useEffect(() => {
        ...
        const getGraphData = async () => {
            ...
            if (country === 'global') {
                ...
                data.labels = globalGraph.date
                data.datasets[0].data = globalGraph.confirmed
                data.datasets[1].data = globalGraph.recovered
                data.datasets[2].data = globalGraph.deaths
            ...
            if (country !== 'global') {
                ...
                data.labels = countryGraph.date
                data.datasets[0].data = countryGraph.confirmed
                data.datasets[1].data = countryGraph.recovered
                data.datasets[2].data = countryGraph.deaths
